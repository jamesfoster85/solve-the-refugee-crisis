(function($){
  ...
  $('input[type="submit"]').click(function(e){
    ...
    var $name = $('input[name="entry.372718999"]').val();
    ...
    var $reason = $('textarea[name="entry.1562080588"]').val();
    var $form = $('.l-join-form');

    $.ajax({
      url: '//docs.google.com/forms/d/1w-8-OnbACv5M7c4KEHJtjXnDGwiPj_vnf7Lw9ereVow/formResponse',
      method: 'POST',
      data: {
        entry.372718999: $name,
        entry.56111174: $email,
        entry.839901740: $organization
        entry.790371713: $role
        entry.1562080588: $reason
      },
      dataType: 'json',
      success: function() {
        $form.fadeOut();
